...
plotS6ContactsPerDay <- function(df_scenario6, p_independent_variable, output_dir, one_plot) {
  ...
  print(plot_ggplot(seg_contacts_gp_by_day_per_agent, p_independent_variable))
  dmfPdfClose()
  
  dmfPdfOpen(output_dir, "s6_contacts_per_agent_smooth")
  print(plot_ggplot_smooth(seg_contacts_gp_by_day_per_agent, p_independent_variable))
  dmfPdfClose()
}
...
#=================== PLOTTING FUNCTIONS ======================
#=============================================================
plot_ggplot <- function(data_to_plot, p_independent_variable) {
...
plot_ggplot_smooth <- function(data_to_plot, p_independent_variable) {
