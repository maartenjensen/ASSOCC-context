...
#setwd(here()) 
setwd("D:/SimulationToolkits/ASSOCC-context/processing/data_processing")
getwd()
...
# Make sure the R script with functions is placed in the working directory (getwd())!
# For example: setwd("D:/SimulationToolkits/ASSOCC-context/processing/data_processing")
# That piece of code sets the working directory to the given directory
rm(list=ls())
