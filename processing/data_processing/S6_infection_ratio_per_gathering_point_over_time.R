...
plot_ggplot <- function(data_to_plot, app_usage) {
  ...
  data_to_plot %>%
    ...
    labs(title=paste("Cummulative infections per gathering point - app usage ratio:", app_usage),
...
plot_ggplot_smooth <- function(data_to_plot, app_usage) {
  ...
  data_to_plot %>%
    ...
    xlab("Days") +
    ylab("Number of infections") +
    labs(title=paste("Cummulative infections per gathering point (Smoothed) - app usage ratio:", app_usage),
         caption="Agent-based Social Simulation of Corona Crisis (ASSOCC)") +
    gl_plot_guides + gl_plot_theme
}
...
plot_ggplot_bar <- function(data_to_plot) {
  ...
  ggplot(data = data_to_plot,aes(x = Gathering_point, 
    ...
    xlab("Days") +
    ylab("Number of infections") +
    labs(title=paste("Cummulative infections per gathering point"),
         caption="Agent-based Social Simulation of Corona Crisis (ASSOCC)",
