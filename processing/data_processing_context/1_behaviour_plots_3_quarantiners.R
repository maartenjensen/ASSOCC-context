behaviourPlot3Quarantiners <- function(plot_specific_f_name) {
  ...
  df_population_status <- select(subset_df, tick, ce_context_depth, count_officially_quarantiners, count_children_with_is_officially_asked_to_quarantine_for_plots_and_not_is_in_quarantine) # uninfected, dead_people, immune, believe_immune, 
  df_population_status <- gather(df_population_status, `Population Status`, measurement, count_officially_quarantiners, count_children_with_is_officially_asked_to_quarantine_for_plots_and_not_is_in_quarantine)
  ...
  p <- p + scale_colour_manual(
    labels=c('count_officially_quarantiners'='Officially asked to quarantine',
             'count_children_with_is_officially_asked_to_quarantine_for_plots_and_not_is_in_quarantine' ='Breaking quarantine'),
    values=c('#2269ee', '#b00300'),
    breaks=c('count_officially_quarantiners','count_children_with_is_officially_asked_to_quarantine_for_plots_and_not_is_in_quarantine'))
