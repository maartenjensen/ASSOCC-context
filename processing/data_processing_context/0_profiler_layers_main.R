...
source("../0_profiler_layers_support.R")
...
#==== PLOTTING                              ===
#==============================================
source("../0_profiler_layers_plots.R")

# Print the table for the means, this is the concluding data in the thesis

baseline_01_delib_time <- df_p_overview_mean[df_p_overview_mean$preset=="0.1 Original ASSOCC" &
                                             df_p_overview_mean$function_name=="CONTEXT-SELECT-ACTIVITY", ]$incl_t_ms_mean
