...
dmfConvertTicksToWeek <- function(p_tick_vector) {
  
  ticks_per_week = 4 * 7
  v_weeks <- floor(p_tick_vector / ticks_per_week)
  return(v_weeks)
}
...
dmfPdfOpen <- function(p_output_dir, p_file_name, p_width=gl_pdf_width, p_height=gl_pdf_height) {
