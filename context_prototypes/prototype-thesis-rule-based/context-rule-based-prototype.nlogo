...
people-own [
  dc ; decision-context (table:make)
  as ; action-set (list: [])
]
...
to go
  ...
  ask people [
    ...
    ifelse length as = 1
    [
      output-print (word "Perform action: " (item 0 as))
      dc-reset
      increment-time
    ]
    [
...
to-report get-dc-key-actions-default
  report "actions-d"
end

to-report get-dc-key-actions-preferred
  report "actions-p"
end

to-report get-dc-key-time
  report "time"
end

; Context OR action expansion rules
to-report dc-expand-minimal-context
  table:put dc get-dc-key-time slice-of-the-day

  set as lput get-action-rest-at-home as
end

to-report dc-expand-minimal-context-actions
